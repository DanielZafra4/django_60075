...
from inicio.views import mi_vista, inicio, vista_datos1, primer_template, segundo_template, crear_auto_correcto, buscar_auto, crear_auto
app_name = "inicio"
...
urlpatterns = [
    ...
    path('crear-auto-correcto/<str:marca>/<str:modelo>/<int:anio>/', crear_auto_correcto, name="crear_auto_correcto"),
