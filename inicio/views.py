...
def inicio(request):
    return HttpResponse("<h1> Hola soy la pantalla del inicio </h1>")
...
def primer_template(request):
    # archivo_template = open(r'templates\primer_template.html')
    ...
    #con with
    with open(r'templates\primer_template.html') as archivo_template:
        template = Template(archivo_template.read())
...
def segundo_template(request):
    ...
    #v1
    # with open(r'templates\segundo_template.html') as archivo_template:
    #     template = Template(archivo_template.read())
